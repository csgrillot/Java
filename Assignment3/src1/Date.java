...
public class Date implements Comparable, Cloneable {
	 ...
	 *            -- the month
	 * @param y
	 *            -- the year repsonses -- if invalid date the erroronous data
	 *            is simply passed on
	 */
	{
		day = d;
	...
	/**
	 * precondition m/d is valid postconditions day=d, month=m, year => 2000
	...
	public Date(int d)
	/**
	 * preconditions d is valid postconditions day=d, year => 2000, month => 12
	...
	public Date()
	/**
	 * null constructor preconditions none postcondtitions -- initializes date
	 * to 31/12/2000
	 */
	{
		day = 31;
	...
	// accessors
	public int getDay() {// day of this date
		return day;
	}

	public int getMonth() {// month of this date
		return month;
	}

	public int getYear() {// year of this date
		return year;
	}
	...
	public boolean equals(Object d1) {
		return (d1 instanceof Date && day == ((Date) d1).day && month == ((Date) d1).month && year == ((Date) d1).year);
	}
